...
log_reg_1.fit(log_reg_X_std, y1)

log_Reg_y2 = np.where(iris_Data.target == 1, 1, 0)
log_reg_2.fit(log_reg_X_std, y2)


log_Reg_y3 = np.where(iris_Data.target == 2, 1, 0)
log_reg_3.fit(log_reg_X_std, y3)
...
for i in range( 0, 150):
    lr_irisClassifierOne = log_reg_1.net_input(log_reg_X_std[i])
    lr_irisClassifierTwo = log_reg_2.net_input(log_reg_X_std[i])
    lr_irisClassifierThree = log_reg_3.net_input(log_reg_X_std[i])
...
for i in range( len( wine_Data.target ) ):
    ...
    wineClassifierOne = log_reg_4.net_input(log_Reg_W_std[i])
    wineClassifierTwo = log_reg_5.net_input(log_Reg_W_std[i])
    wineClassifierThree = log_reg_6.net_input(log_Reg_W_std[i])
